...
# 1) Gelişmiş Teknik İndikatörler
...
# Hedef değişken (24 saatlik sonrası için)
horizon = 24
...
# Callbacks
es = EarlyStopping(monitor='val_loss', patience=15, restore_best_weights=True, min_delta=0.0001)
rlp = ReduceLROnPlateau(monitor='val_loss', factor=0.2, patience=5, min_lr=1e-6)
